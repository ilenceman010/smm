...
$load = sys_getloadavg();
$API_KEY = "7678351966:AAGYXksejAuaEl_p-nqQYsN-zJjv0RIGs_Y"; //TOKEN
...
$ADMIN = '5982050861'; //ADMIN ID
$user = file_get_contents("Member.txt");
$tc = $update->message->chat->type;
$truechannel = json_decode(file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@GODxUNKNOWN&user_id=".$from_id));
$tch = $truechannel->result->status;
...
Feel free to contact @NOTxIT with questions and suggestions!
*",
        'parse_mode'=>'MarkDown',
        	'reply_markup'=>json_encode([
	'resize_keyboard'=>true,
...
🤖: http://t.me/SILENT_SMM_BOT?start=$chat_id";
       bot('sendphoto',[
 'chat_id'=>$chat_id,
...
┌👤 Bot admin : @NOTxIT
├📡 Info Channel: @GODxUNKNOWN
├👥 Our Chat : @GODxUNKNOWN
├💾 Hosting : plughost.in
├🚀 Developers: @NOTxIT
└🛍 ️Developer: @NOTxIT*",
        'parse_mode'=>'MarkDown',
